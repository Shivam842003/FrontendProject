...
import CategorysToggleFilter from './CategoryToggeleFilter';
import InitialProducts from '../common/InitialProducts';
import { Alert, Snackbar} from '@mui/material';

const FilterProducts = (products, setDisplayProducts) => {
    const displaySetting = useSelector((state) => state.productPageFilter);
 ...
 export const Filters = ({isHideSort}) => {
    return(
        <div style={{display: 'flex', marginTop: '20pz'}}>
            <SortProductFilter isHide= {isHideSort}/>
            <CategorysToggleFilter />
 ...
 export default function Content () {
    ...
    let prooducts = JSON.parse(localStorage.getItem('producyts'));
